...
export const PERMISSION_REGISTRY: PermissionDefinition[] = [
  ...
  // ─── Members (Level 2+) ───────────────────────────────────────────────────
  {
    ...
    label: "View Members",
    category: "Members",
    affects: "Members tab in organization detail and members listing page",
    requires: ["settings.organization.view"],
    routes: ["/settings/members", "/settings/organizations/[id]", "/settings/organizations/[id]/members"],
  },
  {
