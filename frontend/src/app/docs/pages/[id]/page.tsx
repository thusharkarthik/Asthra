  ...
  return (
    <div className="space-y-4">
      ...
      <EntityDetailHeader
        ...
        actions={<Button size="sm" onClick={startEditing}>Edit</Button>}
      />
        ...
        <div className="space-y-4">
          <DetailPanel title="Overview">
            <div className="grid gap-3 text-sm sm:grid-cols-3">
              ...
              <div><div className="text-muted-foreground">Version</div><div className="font-medium">Version info placeholder</div></div>
            </div>
          </DetailPanel>
