...
export type ThreadCreate = { workspace_id: number; project_id?: number | null; entity_type?: string | null; entity_id?: number | null; title: string; status?: string; created_by_id: number };
...
export type AnnouncementCreate = { workspace_id: number; title: string; content: string; status?: string; created_by_id: number };
