...
ACTION_NAMES: dict[str, str] = {
    ...
    "invite": "Invite",
    "remove": "Remove",
    "view.roles": "View Role Assignments for",
    "view.permissions": "View Effective Permissions for",
    "view.teams": "View Teams for",
    "assign": "Assign",
    "resend": "Resend",
    "cancel": "Cancel",
    "publish": "Publish",
...
REGISTRY_DEFINITIONS: dict[str, dict[str, tuple[str, list[str]]]] = {
    "settings": {
        ...
        "member": ("workspace", ["view", "invite", "remove", "resend", "cancel", "manage", "view.roles", "view.permissions", "view.teams"]),
        ...
        "navigation": ("organization", ["view", "manage"]),
    },
    "flow": {
