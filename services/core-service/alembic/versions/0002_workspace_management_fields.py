...
Revision ID: 0002_workspace_management_fields
...
revision: str = "0002_workspace_management_fields"
...
def upgrade() -> None:
    with op.batch_alter_table("workspaces") as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_workspaces_created_by_id_users",
            "users",
            ["created_by_id"],
            ["id"],
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("workspaces") as batch_op:
        batch_op.drop_constraint("fk_workspaces_created_by_id_users", type_="foreignkey")
